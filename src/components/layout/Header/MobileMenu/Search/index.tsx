...
export const Search = ( { onClick }: SearchProps ) => {
    return (
        <div className="flex w-full cursor-pointer items-center gap-4 rounded-full px-1 py-1 sm:px-2 md:max-w-[480px] md:flex-grow md:gap-3 md:bg-neutral-800 md:px-4 lg:flex-grow-0 lg:justify-center">
            <svg
                onClick={onClick}
                width="24"
                height="24"
