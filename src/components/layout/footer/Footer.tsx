...
export const Footer = () => {
  return <div className="bg-neutral-800 container pt-12 pb-48 text-white">
      <Image
      ...
      <p className={cn("mt-4 text-sm", nunito.className)}>We specialize in providing a wide range of car styling accessories & components.
         ...
         <div className="flex flex-col gap-6 mt-8">
          ...
          <div className={cn("flex flex-row gap-7 font-light", nunito.className)}>
         ...
         <div className="flex flex-col gap-6 mt-8">
          ...
          <div className={cn("flex flex-row gap-7 font-light mt-4", nunito.className)}>
