...
export const Footer = () => {
    return (
        <footer className="bg-neutral-800 relative z-10">
            <div className="container-v2 pb-24 pt-12 text-white md:pt-20 lg:flex lg:flex-row lg:justify-between lg:gap-16">
