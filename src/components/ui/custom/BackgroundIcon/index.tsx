    ...
    return (
        <svg className={cn( className )} width="1409" height="1409" fill="none" xmlns="http://www.w3.org/2000/svg">
            <mask id="a" maskUnits="userSpaceOnUse" x="0" y="0" width="1409" height="1409">
                <circle cx="704.682" cy="704.682" r="703" fill="#fff" stroke="#000" stroke-width="2"/>
            </mask>
            <g mask="url(#a)">
                ...
                <stop stop-color="#7DFFFF" stop-opacity=".02"/><stop offset="1" stop-color="#4BCCD2" stop-opacity=".3"/>
                ...
                <stop stop-color="#7DFFFF" stop-opacity="0"/><stop offset="1" stop-color="#4BCCD2" stop-opacity=".3"/>
            </linearGradient></defs>
        </svg>
    )
}
